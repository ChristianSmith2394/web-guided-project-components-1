...
function makeImg({ imageURL }) {  //Object restructuring
  // Step 1: create element:
  const image = document.createElement('img')    // argument has to be string that is also HTML tag.
  // Step 2: add content to the element (optional)
  image.src = imageURL
